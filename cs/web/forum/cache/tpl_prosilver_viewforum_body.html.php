...
<?php if ($this->_rootref['GYM_LINKS_CAT']) {  ?><h3><?php echo (isset($this->_rootref['GYM_HTML_FORUM_NEWS_LINK'])) ? $this->_rootref['GYM_HTML_FORUM_NEWS_LINK'] : ''; ?> <?php echo (isset($this->_rootref['GYM_HTML_FORUM_MAP_LINK'])) ? $this->_rootref['GYM_HTML_FORUM_MAP_LINK'] : ''; ?> <?php echo (isset($this->_rootref['GYM_RSS_FORUM_LINK'])) ? $this->_rootref['GYM_RSS_FORUM_LINK'] : ''; ?> <?php echo (isset($this->_rootref['GYM_GOOGLE_FORUM_LINK'])) ? $this->_rootref['GYM_GOOGLE_FORUM_LINK'] : ''; ?></h3><?php } if ($this->_rootref['FORUM_DESC'] || $this->_rootref['MODERATORS'] || $this->_rootref['U_MCP']) {  ?>
