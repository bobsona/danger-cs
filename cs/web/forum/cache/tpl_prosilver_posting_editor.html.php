...
<fieldset class="fields1">
	...
	<?php if ($this->_rootref['S_URL']) {  ?>

	<dl style="clear: left;">
		<dt><label for="url">URL:</label></dt>
			<dd><input type="text" name="url" id="url" size="45" maxlength="250" tabindex="2" value="<?php echo (isset($this->_rootref['TOPIC_URL'])) ? $this->_rootref['TOPIC_URL'] : ''; ?>" class="inputbox autowidth" /></dd>
	</dl>
