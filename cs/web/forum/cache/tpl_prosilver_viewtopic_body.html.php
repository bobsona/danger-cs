...
<?php } if ($this->_rootref['S_RELATED_RESULTS']) {  ?><div class="clear">&nbsp;</div><br /><br />
<div class="forumbg">
	<div class="inner"><span class="corners-top"><span></span></span>
		<ul class="topiclist">
			<li class="header">
				<dl class="icon">
					<dt><?php echo ((isset($this->_rootref['L_RELATED_TOPICS'])) ? $this->_rootref['L_RELATED_TOPICS'] : ((isset($user->lang['RELATED_TOPICS'])) ? $user->lang['RELATED_TOPICS'] : '{ RELATED_TOPICS }')); ?></dt>
	...
	<li class="row bg1<?php if ($_related_val['S_POST_ANNOUNCE']) {  ?> announce<?php } if ($_related_val['S_POST_STICKY']) {  ?> sticky<?php } if ($_related_val['S_TOPIC_REPORTED']) {  ?> reported<?php } ?>">
		<dl class="icon" style="background-image: url(<?php echo $_related_val['TOPIC_FOLDER_IMG_SRC']; ?>); background-repeat: no-repeat;">
			<dt <?php if ($_related_val['TOPIC_ICON_IMG'] && $this->_rootref['S_TOPIC_ICONS']) {  ?> style="background-image: url(<?php echo (isset($this->_rootref['T_ICONS_PATH'])) ? $this->_rootref['T_ICONS_PATH'] : ''; echo $_related_val['TOPIC_ICON_IMG']; ?>); background-repeat: no-repeat;"<?php } ?>><?php if ($_related_val['S_UNREAD_TOPIC']) {  ?><a href="<?php echo $_related_val['U_NEWEST_POST']; ?>"><?php echo (isset($this->_rootref['NEWEST_POST_IMG'])) ? $this->_rootref['NEWEST_POST_IMG'] : ''; ?></a> <?php } ?><a class="topictitle" href="<?php echo $_related_val['U_TOPIC']; ?>" title="<?php echo $_related_val['TOPIC_TITLE']; ?> : <?php echo $_related_val['FORUM']; ?>"><?php echo $_related_val['TOPIC_TITLE']; ?></a>
			...
			<?php if ($_related_val['PAGINATION']) {  ?><strong class="pagination"><span><?php echo $_related_val['PAGINATION']; ?></span></strong><?php } if ($_related_val['ATTACH_ICON_IMG']) {  echo $_related_val['ATTACH_ICON_IMG']; ?> <?php } echo ((isset($this->_rootref['L_POST_BY_AUTHOR'])) ? $this->_rootref['L_POST_BY_AUTHOR'] : ((isset($user->lang['POST_BY_AUTHOR'])) ? $user->lang['POST_BY_AUTHOR'] : '{ POST_BY_AUTHOR }')); ?> <?php echo $_related_val['TOPIC_AUTHOR_FULL']; ?> &raquo; <?php echo $_related_val['FIRST_POST_TIME']; ?>

			</dt>
			<dd class="posts"><?php echo $_related_val['REPLIES']; ?> <dfn><?php echo ((isset($this->_rootref['L_REPLIES'])) ? $this->_rootref['L_REPLIES'] : ((isset($user->lang['REPLIES'])) ? $user->lang['REPLIES'] : '{ REPLIES }')); ?></dfn></dd>
			<dd class="views"><?php echo $_related_val['VIEWS']; ?> <dfn><?php echo ((isset($this->_rootref['L_VIEWS'])) ? $this->_rootref['L_VIEWS'] : ((isset($user->lang['VIEWS'])) ? $user->lang['VIEWS'] : '{ VIEWS }')); ?></dfn></dd>
			<dd class="lastpost"><span><dfn><?php echo ((isset($this->_rootref['L_LAST_POST'])) ? $this->_rootref['L_LAST_POST'] : ((isset($user->lang['LAST_POST'])) ? $user->lang['LAST_POST'] : '{ LAST_POST }')); ?> </dfn><?php echo ((isset($this->_rootref['L_POST_BY_AUTHOR'])) ? $this->_rootref['L_POST_BY_AUTHOR'] : ((isset($user->lang['POST_BY_AUTHOR'])) ? $user->lang['POST_BY_AUTHOR'] : '{ POST_BY_AUTHOR }')); ?> <?php echo $_related_val['LAST_POST_AUTHOR_FULL']; ?>

				<a href="<?php echo $_related_val['U_LAST_POST']; ?>"><?php echo (isset($this->_rootref['LAST_POST_IMG'])) ? $this->_rootref['LAST_POST_IMG'] : ''; ?></a><br /><?php echo $_related_val['LAST_POST_TIME']; ?>

				<?php if ($_related_val['U_FORUM'] && ! $_related_val['S_POST_GLOBAL']) {  ?><br /><a class="topictitle" href="<?php echo $_related_val['U_FORUM']; ?>" title="<?php echo $_related_val['FORUM']; ?>"><?php echo $_related_val['FORUM']; ?></a><?php } ?></span></dd>
		</dl>
	</li>
	<?php }} ?>
