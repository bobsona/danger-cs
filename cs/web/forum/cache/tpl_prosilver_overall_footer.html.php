...
<div id="page-footer">
	...
	<div class="navbar">
		...
		<ul class="linklist<?php if ($this->_rootref['GYM_LINKS']) {  ?> navlinks<?php } ?>">
		...
		<?php if ($this->_rootref['GYM_LINKS']) {  ?>

		<ul class="linklist">
			<?php if ($this->_rootref['GYM_HTML_NEWS_LINK']) {  ?><li class="leftside"><?php echo (isset($this->_rootref['GYM_HTML_NEWS_LINK'])) ? $this->_rootref['GYM_HTML_NEWS_LINK'] : ''; ?></li><?php } if ($this->_rootref['GYM_HTML_MAP_LINK']) {  ?><li class="leftside"><?php echo (isset($this->_rootref['GYM_HTML_MAP_LINK'])) ? $this->_rootref['GYM_HTML_MAP_LINK'] : ''; ?></li><?php } if ($this->_rootref['GYM_GOOGLE_LINK']) {  ?><li class="leftside"><?php echo (isset($this->_rootref['GYM_GOOGLE_LINK'])) ? $this->_rootref['GYM_GOOGLE_LINK'] : ''; ?></li><?php } if ($this->_rootref['GYM_RSS_LINK']) {  ?><li class="leftside"><?php echo (isset($this->_rootref['GYM_RSS_LINK'])) ? $this->_rootref['GYM_RSS_LINK'] : ''; ?></li><?php } if ($this->_rootref['GYM_RSS_CHAN_LINK']) {  ?><li class="leftside"><?php echo (isset($this->_rootref['GYM_RSS_CHAN_LINK'])) ? $this->_rootref['GYM_RSS_CHAN_LINK'] : ''; ?></li><?php } ?>
